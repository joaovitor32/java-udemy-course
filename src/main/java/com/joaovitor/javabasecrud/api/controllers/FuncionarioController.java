...
import com.joaovitor.javabasecrud.api.dtos.FuncionarioDto;
...
public class FuncionarioController{
    ...
    public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id
        ...
        Optional<FuncionarioDto> funcionario = this.funcionarioService.buscarPorId(id);

        if(!funcionario.isPresent()){
            result.addError(new ObjectError("funcionario", "Funcionario não encontrado"));
        }

        this.atualizarDadosFuncionario(funcionaro.get(), funcionarioDto, result);
        ...
        reponse.setData(this.converterFuncionarioDto(funcionario.get()))
