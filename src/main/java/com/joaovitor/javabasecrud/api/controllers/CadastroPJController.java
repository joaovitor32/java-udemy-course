...
import org.springframework.web.RequestBody;
import org.springframework.web.RequestMapping;
import org.springframework.web.RestController;

import com.joaovitor.javabasecrud.api.dtos.CadastroPJDto;
...
import com.joaovitor.javabasecrud.api.respose.Response;
import com.joaovitor.javabasecrud.api.services.EmpresaService;
...
public class CadastroPJController {
     ...
     */
    @PostMapping 
    // Pesquisar ResponseEntity e Response
    public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto, BindingResult result) throws NoSuchAlgorithmException {
        log.info("Cadastrando PF: {}", cadastroPJDto.toString());
    ...
    private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result){
        tthis.empresaService.buscarPorCnpj(cadastroPJDto.getCnpj())
    ...
    private CadastroPJDto converterCadastroPJDto(Funcionario funcionario){
        ...
        cadastroPJDto.setRazaoSocial(funcionario.getRazaoSocial());
        cadastroPJDto.setCnpj(funcionario.getCnpj());
