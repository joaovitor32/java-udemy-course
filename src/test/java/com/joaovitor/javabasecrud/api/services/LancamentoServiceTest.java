...
public class LancamentoServiceTest {
    ...
    public void setUp() throws Exception {
        BDDMockito.
            given(this.funcionarioRepository.findByFuncionarioId(Mockito.anyLong(), Mockito.any(PageRequest.class)))
     ...
     public void testBuscarLancamentoPorFuncionarioId(){
        Page<Lancamento> lancamento = this.lancamentoService.buscarPorFuncionarioId(1L, new Page(0, 10));
